...
# Catalogo confirmado ao vivo via GET /v1/models (2026-08-08), sem chave
# necessaria pra listar. model_registry.py mantem a copia canonica com
# descricoes -- lista aqui e so o fallback minimo do client isolado.
