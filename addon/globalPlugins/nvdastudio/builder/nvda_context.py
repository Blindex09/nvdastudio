...
def _build_nvda_addon_chat_system(docs_dir: str = _NVDA_DOCS_DIR) -> str:
	...
	# 2026-08-16: template oficial ainda inclui "updateChannel", que NAO existe
	# no configspec real do NVDA (confirmado contra nvaccess/nvda master) --
	# aviso pro chat nao ensinar isso como campo valido se o usuario perguntar
	# sobre manifest.ini.
